...
const dialogsElements = state.dialogs.map(d => <DialogItems name={d.name} id={d.id} avatar={d.avatar} /> )
const messagesElements = state.messages.map(m => <Messages message={m.message} />)
